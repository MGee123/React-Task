...
export const routes = [
  { path: 'question1', component: Question1 }, { path: 'question2', component: Question2 }, { path: 'question3', component: HelloK }, { path: 'question4', component: Person }, { path: 'question5', component: Propson }, { path: 'question6', component: Adder }, { path: 'question7', component: Lister }, { path: 'question8', component: Even }, { path: 'question9', component: Bold }, { path: 'question11', component: Company }, { path: 'question12', component: Text }, { path: 'question14', component: Buttoner }, { path: 'question123', component: Random },
